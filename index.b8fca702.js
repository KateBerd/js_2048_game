...
"use strict";
const Game = require("9e98e9d772154ea3");
const game = new Game();
...
},{"9e98e9d772154ea3":"eIbh2"}],"eIbh2":[function(require,module,exports) {
"use strict";
/**
 ...
 */ class Game {
    ...
    generateRandomTile(count = 1) {
        ...
        for(let i = 0; i < count; i++)if (emptyCells.length > 0) {
            const { row, col } = emptyCells.splice(Math.floor(Math.random() * emptyCells.length), 1)[0];
    ...
    moveLeft() {
        ...
        if (!this.areBoardsEqual(previousBoard, this.board)) this.generateRandomTile(1);
